    ...
    <div className="py-8">
      ...
      <div className="mb-12">
        ...
        <div className="relative">
          {/* Timeline Line */}
          <div className="absolute left-1/2 transform -translate-x-1/2 w-1 h-full bg-gradient-to-b from-gray-300 to-blue-500 rounded-full"></div>
          
          {/* Belt Levels */}
          <div className="space-y-12">
            {punchesData.beltLevels.map((beltLevel, index) => (
        ...
        <div className="inline-flex items-center space-x-8 text-foreground/60 text-sm">
          <div>
            <div className="text-2xl font-bold text-primary">
              {punchesData.beltLevels.reduce((total, level) => total + level.techniques.length, 0)}
            </div>
